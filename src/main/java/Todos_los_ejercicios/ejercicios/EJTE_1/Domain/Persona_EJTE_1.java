package Todos_los_ejercicios.ejercicios.EJTE_1.Domain;
...
public class Persona_EJTE_1 {
    ...
    public Persona_EJTE_1() {
        System.out.println(this.id_persona+"/"+this.usuario);
    }

    public Persona_EJTE_1(PersonaInputDTO persona_dto){
...
*/
    ...
    public Persona_EJTE_1(PersonaOutputDTO persona_dto){
